...
#[UniqueEntity(fields: ['email'], message: 'Un compte utilise déjà cette adresse mail.')]
#[UniqueEntity(fields: ['name'], message: "Un compte utilise déjà ce nom d'utilisateur.")]
